...
<section id="connect-with-us" class="text-gray-600 body-font relative my-6 mx-4">
    ...
    <div class="container px-4 py-24 mx-auto flex">
        <form action="#connect-with-us" method="post" class="lg:w-1/3 md:w-1/2 bg-white rounded-lg px-4 py-8 flex flex-col md:ml-auto w-50% mt-10 md:mt-0 relative z-10 shadow-md">

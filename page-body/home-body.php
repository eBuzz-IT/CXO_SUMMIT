        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-8 mx-auto">
                <div class="flex flex-col">
                    ...
                    <br>
                    <div class="py-6 mb-4 lg:mx-44 md:mx-24 nav-txt ring-4 ring-black rounded-lg shadow-2xl italic uppercase lg:font-extrabold">
                        <center>
